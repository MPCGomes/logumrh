...
const HeroSection: FC = () => (
  <section className={clsx(styles.mainContainer, "container", "section")}>
    <div className={styles.contentWrapper}>
      <div className={styles.scalableContent}>
        <div className={styles.heroContainer}>
          <div className={styles.textContainer}>
            <h1>Processos seletivos humanizados e eficientes</h1>
            <h3>
              A melhor solução para o Recrutamento e Seleção no Litoral Norte e
              Vale do Paraíba! Economize tempo e dinheiro e encontre o candidato
              ideal com nossa equipe especializada.
            </h3>
